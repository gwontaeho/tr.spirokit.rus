  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-center">{t("PJ.M_14")}</div>
...
export const Main = () => {
  ...
  const values = {
    ...
    subjectDetails: {
      ...
      smoking:
        subject.subjectDetails?.smokingExperience === false
          ? undefined
          : String(subject.subjectDetails?.smoking),
    },
  };
  ...
  const { mutate, isLoading } = useMutation({
    mutationFn: (variables) =>
      updateSubject({ chartNumber, values: variables }),
      ...
      <main className="p-8">
        ...
        >
          ...
          <div className="flex space-x-4">
            ...
            <button className="input flex-1">{t("PJ.MOD")}</button>
          </div>
        </form>
      </main>
