        ...
        <div className="space-y-4">
          ...
          <div className="card">
            <div className="p-4 flex items-center space-x-2">
              <div className="font-medium">{t("PJ.MEA_LEV")}</div>
              <div className="text-sm">({t("PJ.M_10")})</div>
            </div>
          ...
          <div className="card">
            <div className="p-4 font-medium">{t("PJ.DIAG_RSLT")}</div>
          ...
          <div className="card">
            <div className="p-4 flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <div className="font-medium">{t("PJ.ERR_CD")}</div>
              ...
              <div className="text-sm">*{t("PJ.M_11")}</div>
            </div>
