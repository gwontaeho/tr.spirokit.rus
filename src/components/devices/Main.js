    ...
    <div className="absolute w-0 h-0 overflow-hidden">
      ...
      >
        ...
        <div className="border border-black mb-[16px] font-[600] [&>div>div]:py-1.5 [&>div>div]:px-3">
          ...
          <div className="flex">
            <div className="flex-1 border-r border-black">{t("CR.HUM")}(%)</div>
        ...
        <div className="border border-black mb-[16px] font-[600] [&>div>div]:py-1.5 [&>div>div]:px-3">
          <div className="flex border-b border-black">
            <div className="flex-1 border-r border-black">{t("CR.I_GAIN")}</div>
            <div className="flex-1">{gain.inhale}</div>
          </div>
          <div className="flex">
            <div className="flex-1 border-r border-black">{t("CR.E_GAIN")}</div>
...
export const Main = () => {
  ...
  return (
    <>
      ...
      {calibrationQuery.isSuccess && (
        <Report selectedDevice={selectedDevice} calibration={calibration} />
      )}
    </>
  );
};
